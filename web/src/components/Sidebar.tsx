...
const NAV = [
  ...
  { href: "/settings", label: "Settings", icon: "⚙", desc: "Models & offline" },
];
          ...
          {!collapsed ? (
            <>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[11px] text-[#8e8e8e] truncate">Local-first • Offline-capable</div>
              </div>
              <button
        ...
        {!collapsed && (
          <div className="p-3 border-t border-[#2f2f2f]">
            <div className="rounded-xl bg-[#171717] border border-[#2f2f2f] text-[#ececec] p-3">
              <div className="text-xs font-medium text-white">Local-first guarantee</div>
              <div className="text-[11px] text-[#8e8e8e] mt-1 leading-relaxed">SQLite is the source of truth. No cloud DB, no accounts. Your files never leave this machine.</div>
            </div>
          </div>
        )}
        {collapsed && (
